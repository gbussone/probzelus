...
set terminal pdf
set output 'sin-mse-x.pdf'

set xlabel 'Pas'
set logscale y
set ylabel 'MSE (paramètres d''état, échelle log)'

set title 'Sin : Erreur (paramètres d''état) par pas'
...
plot 'particles/error_x.csv' using 1:3:2:4 every 10 with yerrorlines lt 3 pt 5 title 'PF', \
     ...
     'apf_mm/error_x.csv' using 1:3:2:4 every 10 with yerrorlines lt 7 pt 2 title 'APF-MM'

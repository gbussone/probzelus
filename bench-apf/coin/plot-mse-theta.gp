...
set terminal pdf
set output 'coin-mse-theta.pdf'

set xlabel 'Pas'
set logscale y
set ylabel 'MSE (paramètres constants, échelle log)'

set title 'Coin : Erreur (paramètres constants) par pas'
...
plot 'particles/error_theta.csv' using 1:3:2:4 every 10 with yerrorlines lt 3 pt 5 title 'PF', \
     ...
     'apf_mm/error_theta.csv' using 1:3:2:4 every 10 with yerrorlines lt 7 pt 2 title 'APF-MM'

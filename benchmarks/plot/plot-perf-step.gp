...
plot dir.'particles/perf-step.csv' using 1:3:2:4 every 10 with yerrorbars lt 3 pt 5 title 'PF', \
     dir.'apf_is/perf-step.csv' using 1:3:2:4 every 10 with yerrorbars lt 6 pt 13 title 'APF-IS', \
     dir.'apf_mm/perf-step.csv' using 1:3:2:4 every 10 with yerrorbars lt 7 pt 15 title 'APF-MM', \
